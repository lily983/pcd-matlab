...
PCDEB95_narrow_large_path = base_path + "PCDEB95_narrow_large.csv.csv";
PCDEB95_narrow_small_path = base_path + "PCDEB95_narrow_small.csv.csv";
PCDEB95_sparse_large_path = base_path + "PCDEB95_narrow_large.csv.csv";
PCDEB95_sparse_small_path = base_path + "PCDEB95_narrow_small.csv.csv";

PCDGMM_narrow_large_path = base_path + "PCDGMM_sparse_large.csv.csv";
PCDGMM_narrow_small_path = base_path + "PCDGMM_sparse_small.csv.csv";
PCDGMM_sparse_large_path = base_path + "PCDGMM_sparse_large.csv.csv";
PCDGMM_sparse_small_path = base_path + "PCDGMM_sparse_small.csv.csv";

PCDEB95_narrow_large = readtable(PCDEB95_narrow_large_path);
PCDEB95_narrow_small = readtable(PCDEB95_narrow_small_path);
PCDEB95_sparse_large = readtable(PCDEB95_narrow_large_path);
PCDEB95_sparse_small = readtable(PCDEB95_narrow_small_path);

PCDGMM_narrow_large = readtable(PCDGMM_sparse_large_path);
PCDGMM_narrow_small = readtable(PCDGMM_sparse_small_path);
