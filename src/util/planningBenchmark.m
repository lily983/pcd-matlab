...
PCDEB95_clamp_large_path_length = table2array(PCDEB95_clamp_large(1:size(PCDEB95_clamp_large,1)-2,10));
PCDEB95_clamp_small_path_length = table2array(PCDEB95_clamp_small(1:size(PCDEB95_clamp_small,1)-2,10));
...
PCDGMM_clamp_large_path_length = table2array(PCDGMM_clamp_large(1:size(PCDGMM_clamp_large,1)-2,10));
PCDGMM_clamp_small_path_length = table2array(PCDGMM_clamp_small(1:size(PCDGMM_clamp_small,1)-2,10));
%%
% ax1=subplot(3,2,1)
...
title('Clamp environment with small inaccurace')
