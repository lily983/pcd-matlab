...
% 
% [ratio_sphere, time_sphere, ub_sphere, mean_sphere, var_sphere] = calculatePCDBenchmark(resultsSphere, M.keys, TwoErrorCase)
...
% [ratio_ellip, time_ellip, ub_ellip, mean_ellip, var_ellip] = calculatePCDBenchmark(resultsEllip, M.keys, TwoErrorCase)
...
[ratio_SQ, time_SQ, ub_SQ, mean_SQ, var_SQ] = calculatePCDBenchmark(resultsSQ, M.keys, TwoErrorCase)
...
% [ratio_SQ, time_SQ, ub_SQ, mean_SQ, var_SQ] = calculatePCDBenchmark(resultsSQTwoError, M.keys, TwoErrorCase)
